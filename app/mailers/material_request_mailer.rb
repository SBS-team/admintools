class MaterialRequestMailer < ActionMailer::Base
  ...
  def send_material_request(material_request)
    ...
    mail(:to => "jeyboy1985@gmail.com", :subject => t(:'teamleader.mailer.time_request_mailer.new_request'), :template_path => 'teamleader/material_request_mailer', :template_name => 'send_material_request')
  end
